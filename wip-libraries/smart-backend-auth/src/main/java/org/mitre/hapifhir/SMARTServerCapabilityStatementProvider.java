...
public class SMARTServerCapabilityStatementProvider extends ServerCapabilityStatementProvider {
    ...
    public CapabilityStatement getServerConformance(HttpServletRequest request, RequestDetails requestDetails) {
        ...
        CapabilityStatementRestSecurityComponent securityComponent = buildSecurityComponent(tokenAddress);
    ...
    private static CapabilityStatementRestSecurityComponent buildSecurityComponent(String tokenAddress) {
